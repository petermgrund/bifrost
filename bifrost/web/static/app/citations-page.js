...
class CitationsPage extends BifrostElement {
  ...
  renderDescribe() {
    ...
    return html`
      ${this.ctx.house_style === false ? html`<p>${statusLine('error',
        'AI composition is disabled until you create a citation style')}</p>` : nothing}
      ...
      <nav>
        ${this.ctx.llm && this.ctx.house_style !== false
          ? btn(this.busy ? 'Composing...' : 'Compose citation',
